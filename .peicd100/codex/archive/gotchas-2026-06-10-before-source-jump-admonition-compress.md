...
- 證據：verified
- 日期：2026-05-25
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css` 的 `max-width: 76.249em` primary drawer 樣式。
...
- 相關檔案：`theme/assets/pymdownx-extras/自定義.css`、`mkdocs.yml`
...
- 證據：user-requested
- 日期：2026-05-25
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css` 的正文閱讀樣式。
...
- 證據：user-requested
- 日期：2026-05-23
- 影響範圍：`theme/assets/pymdownx-extras/source-jump.js`。
...
- 證據：verified
- 日期：2026-05-22
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、Mermaid flowchart htmlLabels。
...
- 證據：verified
- 日期：2026-05-23
- 影響範圍：`theme/assets/pymdownx-extras/mermaid-config-override.js`、`theme/assets/pymdownx-extras/自定義.css`、Mermaid flowchart 暗色主題。
...
- 證據：verified
- 日期：2026-05-24
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、MkDocs Material heading permalink。
...
- 證據：verified
- 日期：2026-05-24
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、MkDocs Material primary sidebar。
...
- 證據：verified
- 日期：2026-05-24
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、`theme/assets/pymdownx-extras/image-zoom.js`。
...
- 證據：user-requested
- 日期：2026-05-23
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、`mkdocs.yml`、全站深色主題。
...
- 證據：verified
- 日期：2026-05-24
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、MkDocs Material primary sidebar drawer。
...
- 證據：verified
- 日期：2026-05-24
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、`peicd-toc-sidebar`。
...
- 證據：verified
- 日期：2026-05-24
- 影響範圍：`theme/assets/pymdownx-extras/自定義.css`、MkDocs Material blog index。
