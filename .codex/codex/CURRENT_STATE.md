...
- 2026-05-22 已修正 Mermaid htmlLabels 英文字母 descender 被切到的問題：`docs/theme/assets/pymdownx-extras/自定義.css` 將 Mermaid label 行高調整為 `1.18`，並更新 `mkdocs.yml` CSS cache 版本。
